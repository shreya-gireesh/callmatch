"""
Django settings for CallMatch project.
...
SECRET_KEY = 'django-insecure-$n3i+(=aw8@!q!7tc2k^4bf9m&*0d06wum(+_nmjdjir&(e7ny'
...
WSGI_APPLICATION = 'CallMatch.wsgi.application'
